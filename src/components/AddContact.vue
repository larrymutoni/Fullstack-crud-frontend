                ...
                <form @submit.prevent="saveContact" novalidate>
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" v-model="contact.email" class="form-control" placeholder="Enter Email">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" v-model="contact.contact_no" class="form-control" placeholder="Enter Contact Number">
                        </div>
